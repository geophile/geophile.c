#ifndef _SPATIAL_OBJECT_REFERENCE_MANAGER_H
#define _SPATIAL_OBJECT_REFERENCE_MANAGER_H

namespace geophile
{
    template <class SOR>
    class SpatialObjectReferenceManager
    {
    public:
        ...
        // destroyed, providing an opportunity to reverse any side-effects by
